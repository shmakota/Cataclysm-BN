...
auto enchantment_condition::get_all() -> std::vector<enchantment_condition> {
...
auto enchantment_condition::item_condition(const item& it) const -> bool {
    return condition_functions[condition_function]->check_item_condition(it);
}

auto enchantment_condition::item_character_condition(const Character& guy, const item& it) const
    -> bool {
    return condition_functions[condition_function]->check_item_character_condition(guy, it);
}

auto enchantment_condition::character_condition(const Character& guy, const bool active) const
    -> bool {
    return condition_functions[condition_function]->check_character_condition(guy, active);
}

auto enchantment_condition::generic_condition(const bool active) const -> bool {
...
namespace io {
template <>
auto enum_to_string<enchantment_condition_type>(enchantment_condition_type data) -> std::string {
    switch (data) {
...
public:
    auto check_generic_condition(const bool /*active*/) const -> bool override { return true; }
};

class enchantment_condition_dawn: public virtual enchantment_condition_function {
public:
    auto check_generic_condition(const bool /*active*/) const -> bool override {
...
public:
    auto check_generic_condition(const bool active) const -> bool override { return active; }
};
...
public:
    auto check_character_condition(const Character& guy, const bool /*active*/) const
        -> bool override {
...
public:
    auto check_item_character_condition(const Character& guy, const item& it) const
        -> bool override {
...
auto enchantment_condition_lua::check_item_character_condition(
    const Character& guy, const item& it) const -> bool {
...
auto enchantment_condition_lua::check_item_condition(const item& it) const -> bool {
...
auto enchantment_condition_lua::check_character_condition(
    const Character& guy, const bool active) const -> bool {
...
auto enchantment_condition_lua::check_generic_condition(const bool active) const -> bool {
